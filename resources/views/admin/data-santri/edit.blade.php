                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="username"
                                    ...
                                    value="{{ old('username', $santri->user->username) }}" required>
                                @error('username')
                            ...
                            <div class="form-group">
                                ...
                                @if ($santri->photo)
                                    <div class="mt-2">
                                        <p>Foto Saat Ini:</p>
                                        <img src="{{ asset('storage/' . $santri->photo) }}" alt="Foto Santri"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" required>{{ old('alamat', $santri->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="wali_santri"
                                    ...
                                    value="{{ old('wali_santri', $santri->wali_santri) }}" required>
                                @error('wali_santri')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="form-group">
                                ...
                                <input type="text" name="no_hp_wali_santri"
                                    ...
                                    value="{{ old('no_hp_wali_santri', $santri->no_hp_wali_santri) }}">
