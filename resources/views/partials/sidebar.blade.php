        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                @if (Auth::user()->role === 'admin')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('kelas.index') }}" aria-expanded="false">
                            <i data-feather="book" class="feather-icon"></i><span class="hide-menu">Data Kelas</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="{{ route('pengurus.index') }}" aria-expanded="false">
                            <i data-feather="users" class="feather-icon"></i><span class="hide-menu">Data
                                Pengurus</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="{{ route('pengasuh.index') }}" aria-expanded="false">
                            <i data-feather="user-check" class="feather-icon"></i><span class="hide-menu">Data
                                Pengasuh</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="{{ route('santri.index') }}" aria-expanded="false">
                            <i data-feather="users" class="feather-icon"></i><span class="hide-menu">Data Santri</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="{{ route('data-kegiatan.index') }}"
                            aria-expanded="false">
                            <i data-feather="calendar" class="feather-icon"></i><span class="hide-menu">Data
                                Kegiatan</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link sidebar-link" href="{{ route('admin.perizinan-pulang.index') }}"
                            aria-expanded="false">
                            <i data-feather="log-out" class="feather-icon"></i><span class="hide-menu">Data Perizinan
                                Pulang</span>
                        </a>
                    </li>
                    <li class="list-divider"></li>
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow" href="javascript:void(0)" aria-expanded="false">
                            <i data-feather="file-text" class="feather-icon"></i><span
                                class="hide-menu">Rekapitulasi</span>
                        </a>
                        <ul aria-expanded="false" class="collapse first-level base-level-line">
                            ...
                            <li class="sidebar-item"><a href="{{ route('admin.laporan-perizinan-pulang.index') }}"
                                    class="sidebar-link">
                                    <span class="hide-menu">Perizinan Santri</span></a></li>
                        </ul>
                    </li>
                @elseif (Auth::user()->role === 'pengurus')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('pengurus.hafalan.index') }}" aria-expanded="false">
                ...
                @elseif (Auth::user()->role === 'pengasuh')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('pengasuh.pelanggaran.index') }}"
                            aria-expanded="false">
                            <i data-feather="alert-circle" class="feather-icon"></i><span
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('pengasuh.perizinan-pulang.index') }}"
                            aria-expanded="false">
                            <i data-feather="log-out" class="feather-icon"></i><span class="hide-menu">Perizinan
                                Santri</span>
                        </a>
                    </li>
                @elseif (Auth::user()->role === 'santri')
                    ...
                    <li class="sidebar-item">
                        <a class="sidebar-link" href="{{ route('perizinan-pulang.index') }}" aria-expanded="false">
                            <i data-feather="log-out" class="feather-icon"></i><span class="hide-menu">Perizinan
                                Pulang</span>
                        </a>
                    </li>
