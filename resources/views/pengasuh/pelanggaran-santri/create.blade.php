...
@section('content')
    <div class="container-fluid mt-4">
        <h3 class="page-title text-dark font-weight-medium mb-1">Detail Pelanggaran - {{ $dataPelanggaran->pelanggaran }}
        </h3>
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('pengasuh.pelanggaran.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_melanggar"
                            ...
                            value="{{ old('tanggal_melanggar', date('Y-m-d')) }}" required>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('pengasuh.pelanggaran.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
