        ...
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-dark font-weight-medium mb-1">
                    Detail Pelanggaran Saya - {{ $dataPelanggaran->jenis_pelanggaran }}
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="zero_config" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr class="text-center">
                                    <td colspan="3">Belum ada data pelanggaran yang tercatat untuk jenis ini.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <a href="{{ route('santri.pelanggaran-saya.index') }}" class="btn btn-secondary mt-3">Kembali</a>
            </div>
        </div>
    </div>
@endsection
