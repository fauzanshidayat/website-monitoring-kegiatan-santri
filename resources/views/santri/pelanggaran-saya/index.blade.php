    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-dark font-weight-medium mb-1">Pelanggaran Saya</h3>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            @forelse($dataPelanggaran as $index => $item)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{ route('santri.pelanggaran-saya.show', $item->id) }}"
                                            class="btn btn-info btn-sm" title="Lihat Pelanggaran Saya">
