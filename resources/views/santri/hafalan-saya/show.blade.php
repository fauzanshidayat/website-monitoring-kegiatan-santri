        ...
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-dark font-weight-medium mb-1">
                    Detail Hafalan Saya - {{ $dataKegiatan->kegiatan }}
                </h3>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="zero_config" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr class="text-center">
                                    <td colspan="7">Belum ada data hafalan yang tercatat untuk kegiatan ini.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <a href="{{ route('santri.hafalan-saya.index') }}" class="btn btn-secondary mt-3">Kembali</a>
            </div>
        </div>
    </div>
@endsection
