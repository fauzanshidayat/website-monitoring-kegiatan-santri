...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('pengurus.hafalan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <select name="jenis_hafalan" class="form-control @error('jenis_hafalan') is-invalid @enderror"
                            ...
                            @foreach (['surah', 'kitab', 'doa', 'lainnya'] as $jenis)
                                <option value="{{ $jenis }}"
                                    {{ old('jenis_hafalan') == $jenis ? 'selected' : '' }}>
                                    {{ ucfirst($jenis) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kitab_surah"
                            ...
                            value="{{ old('nama_kitab_surah') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="progres_belajar"
                            ...
                            value="{{ old('progres_belajar') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="tanggal_menghafal"
                            ...
                            value="{{ old('tanggal_menghafal', date('Y-m-d')) }}" required>
                    ...
                    <div class="mt-3">
                        ...
                        <a href="{{ route('pengurus.hafalan.index') }}" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
